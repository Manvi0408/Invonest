...
- Name: login.spec.ts >> Login page — Workspace-only validation >> error toast auto-dismisses
- Location: tests\login.spec.ts:131:7
...
- generic [ref=e1]:
  - generic [ref=e4]:
    ...
    - generic [ref=e20]: Or
    - generic [ref=e24]:
      - textbox "Company Email" [ref=e26]: someone@gmail.com
      - generic [ref=e30]:
      ...
      - button "Login to InvoNest" [active] [ref=e54] [cursor=pointer]
